...
################# Internal functions ###################
    def compute_metrics(self, model, verbose=True):
        ...
        if verbose: 
            ...
            try:
                print("Concavity index: {:.10f}".format(abs(concavity)))
                print("Top median residual: {:.10f}".format(abs(top_median_residual)))
                print("Bottom median residual: {:.10f}".format(abs(bottom_median_residual)))
            except:
                pass            
            print("Median residual: {:.10f}".format(median_residual))
            print("R2: {:.10f}".format(r_squared))
